...
export const ProjectCard = ({id, name, description}: ProjectCardProps) => {
    return (
        <motion.div
            ...
            className="bg-[#110c1a] h-auto w-full p-4 rounded-xl border border-purple-300/50 flex hover:shadow-[0_0_15px_rgba(127,0,255,0.4)] hover:bg-violet-950/15 hover:cursor-pointer"
        >
