...
import { CgCheckO, CgList, CgMail, CgRename } from "react-icons/cg"
...
export const Equipe = () => {
    ...
    const listRoles = [
        { "id": 1, "role": "Designer" },
        { "id": 2, "role": "Analista" },
        { "id": 3, "role": "Desenvolvedor" },
        { "id": 4, "role": "Engenheiro" },
    ]
    ...
    return (
        <div id="container" className="min-w-full h-full flex flex-col px-4 md:px-7 pb-5 md:pt-5 min-h-0">    
            ...
            <div id="content" className="bg-[#0F0B15] w-full flex flex-col flex-1 rounded-3xl py-5 px-5 min-h-0">
                ...
                <div id="content-scroll" className="overflow-y-auto simple-scroll">
                    ...
                    <section id="roleSection" className="grid grid-cols-1 lg:grid-cols-2 gap-5 flex-1 p-3 pt-5">
                        
                        {/* Formulário de funções */}
                        <div className="flex flex-col">
                            <div className="flex w-full pl-3 items-center pb-3">
                                <MdPersonAdd className="text-2xl" />
                                <h2 className="p-2 pl-3 text-lg"> Adicionar função </h2>
                            </div>
                            <form action="#" className="w-full max-w-130 pb-2">
                                <CustomInputBox
                                    type="text"
                                    name="role"
                                    placeholder="Função"
                                    icon={<CgList className="text-white" />}
                                    className="bg-white/25 text-white"
                                />
                            </form>
                            <CustomBtn2 
                        ...
                        <div className="py-6 px-4 md:px-8 rounded-xl border border-white/70 flex flex-col justify-between bg-[#110c1a]">
                            ...
                            <div className="flex-1 overflow-y-auto pr-2">
                                {listRoles.map(
                                    (role) => (
                                        <div key={role.id} className="flex items-center justify-between py-2 px-4 mb-2 rounded-2xl border-1 border-white/10">
